...
questions_list = [
    ...
    Question('Какой человек был первым, кто открыл Америку?', 'Христофор Колумб', 'Александр Пушкин', 'Америго Веспуччи', 'Фернан Магеллан')
    Question('Какой человек был первым, кто совершил кругосветное путешествие?', 'Фернан Магеллан', 'Васко да Гама', 'Марко Поло', 'Христофор Колумб')
]
